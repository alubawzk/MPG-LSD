...
double * lsd_scale_region( int * n_out,
                           double * img, int X, int Y, double scale,double sg_sl,double lg_eps,
                           int ** reg_img, int * reg_x, int * reg_y  );
...
/** LSD Simple Interface with Scale
    ...
    @return            A double array of size 7 x n_out, containing the list
                       ...
                       'out[7*n+0]' to 'out[7*n+6]'.
 */
double * lsd_scale(int * n_out, double * img, int X, int Y, double scale,double sg_sl,double log_eps);
...
/** LSD Simple Interface
    ...
    @return            A double array of size 7 x n_out, containing the list
                      ...
                      + The seven values are:
                       ...
                       'out[7*n+0]' to 'out[7*n+6]'.
 */
double * lsd(int * n_out, double * img, int X, int Y,double sl,double sg_sl,double log_eps);
